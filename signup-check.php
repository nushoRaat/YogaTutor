	...
	if (empty($uname)) {
		...
		exit();
			...
			if (mysqli_num_rows($result) > 0) {
				...
				$sql2 = "INSERT INTO user(user_name, password, Name, email, created_date, status) VALUES('$uname', '$pass', '$name','$uemail','$currentTime','1')";
				$result2 = mysqli_query($link, $sql2);
				if ($result2) {
					header("Location: logincss.php?success=Your account has been created successfully");
					exit();
				}
				else {
